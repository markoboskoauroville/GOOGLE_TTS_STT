...
#
#   src/00_head.sh   3a0af77ac8f3
#   src/10_app.py    686b27a4b448
#   src/20_tail.sh   cc50369c799f
#
...
#
#   bash 2-google-tts-stt-v2.sh                 install, then run the tests
#   bash 2-google-tts-stt-v2.sh --keys FILE     install, and take the keys out of FILE
#   bash 2-google-tts-stt-v2.sh --quiet         install, no tests
#   bash 2-google-tts-stt-v2.sh --verify        check this file is whole, change nothing
#
...
GTT_VERSION="v2"
GTT_FILE="2-google-tts-stt-v2.sh"
