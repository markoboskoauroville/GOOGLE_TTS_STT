...
#
#   src/00_head.sh   a4da310ef352
#   src/10_app.py    e989a88bbd42
#   src/20_tail.sh   bb230b0a9454
#
...
#
#   bash 1-google-tts-stt-v1.sh            install, then run the four tests
#   bash 1-google-tts-stt-v1.sh --quiet    install, no tests
#   bash 1-google-tts-stt-v1.sh --verify   check this file is whole, change nothing
#
...
GTT_VERSION="v1"
GTT_FILE="1-google-tts-stt-v1.sh"
