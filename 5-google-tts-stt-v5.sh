...
#
#   src/00_head.sh   f9de45817229
#   src/10_app.py    7b566c2689f0
#   src/20_tail.sh   0a49f533db48
#
...
#
#   bash 5-google-tts-stt-v5.sh                 install, then run the tests
#   bash 5-google-tts-stt-v5.sh --keys FILE     install, and take the keys out of FILE
#   bash 5-google-tts-stt-v5.sh --quiet         install, no tests
#   bash 5-google-tts-stt-v5.sh --verify        check this file is whole, change nothing
#
...
GTT_VERSION="v5"
GTT_FILE="5-google-tts-stt-v5.sh"
